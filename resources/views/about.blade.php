        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="grid gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
                ...
                <div data-aos="fade-left">
                    <p class="section-eyebrow text-[#C8D3FF]">Cara kerja</p>
                    ...
                    <div class="mt-8 space-y-5">
                        @foreach ([
                            ...
                            <div class="flex items-center gap-5 rounded-[1.25rem] bg-stone-900 p-5 ring-1 ring-stone-800">
                                <span class="grid h-12 w-12 shrink-0 place-items-center rounded-full bg-[#12268C] font-black text-white">{{ $step[0] }}</span>
    ...
    <section class="bg-white py-20 sm:py-28">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="overflow-hidden rounded-[2rem] bg-[#EEF1FF] p-8 sm:p-12 lg:flex lg:items-center lg:justify-between">
                ...
                <a href="/#contact" data-aos="fade-left" class="mt-8 inline-flex items-center gap-3 rounded-full bg-[#12268C] px-6 py-4 text-sm font-bold text-white transition hover:bg-[#0f2075] lg:mt-0">
                    Hubungi kami
                </a>
            </div>
        </div>
